...
public class ReservationTable_ForWorker {
    ...
    String worker_name,home_ownername,reservation_date,reservation_start_time,reservation_end_time,reservation_details,submit_dateTime,
            worker_remark,worker_reply,homeowner_reply;

    public ReservationTable_ForWorker(Integer reservation_id, Integer home_owner_id, Integer worker_id, String home_ownername, String reservation_date, String reservation_start_time, String reservation_end_time, String reservation_details, String submit_dateTime, String worker_remark, String worker_reply, String homeowner_reply) {
        this.reservation_id = reservation_id;
        this.home_owner_id = home_owner_id;
        this.worker_id = worker_id;
        this.home_ownername = home_ownername;
    ...
    public String getHome_ownername() {
        return home_ownername;
    }

    public void setHome_ownername(String home_ownername) {
        this.home_ownername = home_ownername;
    }
